...
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        const query = 'INSERT INTO courses (title, description, created_at, updated_at) VALUES ($1, $2, NOW(), NOW()) RETURNING *';
...
router.put('/:id', authenticateJWT, async (req, res) => {
    try {
        ...
        const query = 'UPDATE courses SET title = $1, description = $2, updated_at = NOW() WHERE id = $3 RETURNING *';
